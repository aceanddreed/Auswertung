...
\begin{enumerate}
	...
	\begin{figure}[H]
		\begin{minipage}{.5\textwidth}
			...
			\caption{\textit{The image shows a sketch drawn to represent scenario one of the Drawing Study. It is a conventional line graph for the decreasing probability of catching the bus over time.}}
			\label{fig:drawingT1}
		\end{minipage}
